...
public class Driver 
{
	...
	public static void main(String[] args)
	{
		while (true){
		Driver.displayBoard();
		System.out.print("First player turn ");
		...
		Driver.displayBoard();
		System.out.print("Second player trun ");
		System.out.print("Please enter a row:");
		int row1 = Driver.getIntFromUser();
		System.out.print("Please enter a column:");
		int column1 = Driver.getIntFromUser();
		Driver.makeMove(row1, column1, 'O');}
